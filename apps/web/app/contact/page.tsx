...
export default async function ContactPage({ searchParams }: ContactPageProps) {
  ...
  const copy = {
    en: {
      ...
      description:
        "Whether you are exploring your options personally or writing on behalf of a firm, this page explains the most suitable way to get in touch, what each route is intended to cover, and how the first exchange is usually framed.",
    ...
    reachTitle:
      locale === "ar"
        ...
        : locale === "ru"
          ...
          : "One contact point, framed with discretion.",
    reachDescription:
      locale === "ar"
  ...
  return (
    <SiteShell>
      <PageHero
        ...
        stats={[
          { value: "Private correspondence", label: "for discreet written enquiries and follow-up" },
          { value: "Investor and professional routes", label: "so the first exchange begins in the right context" },
          { value: "Measured communication", label: "designed to stay calm, clear, and privacy-aware" },
        ]}
      />
      ...
      <section className="section-padding pt-0">
        <div className="container-shell">
          <CtaPanel
            ...
            secondaryAction={{ href: ctaLinks.viewPricing, label: locale === "ar" ? "اطلع على الحلول" : "View solutions" }}
          />
        </div>
      </section>
    </SiteShell>
