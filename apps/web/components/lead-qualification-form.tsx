    ...
    <div dir={isRtl ? "rtl" : "ltr"} className={cn("section-card p-7 md:p-9", isRtl && "text-right")}>
      ...
      <Form {...form}>
        <form
          ...
          action="/__forms.html"
          className={cn(
            "space-y-6 [&_input]:h-11 [&_label]:text-[0.78rem] [&_label]:font-medium [&_label]:tracking-[0.01em] [&_label]:text-foreground/72 [&_textarea]:rounded-2xl [&_[role=combobox]]:h-11 [&_[role=combobox]]:rounded-2xl",
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                              <Input dir={isRtl ? "ltr" : undefined} className={cn(isRtl && "text-left")} placeholder={contactDetails.whatsapp} autoComplete="tel" inputMode="tel" spellCheck={false} {...field} />
                          </FormControl>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Textarea rows={5} className={cn(isRtl && "text-right")} placeholder={copy.notesPlaceholder} onKeyDown={handleTextareaKeyDown} {...field} />
                          </FormControl>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>{copy.emailLabel}</FormLabel>
                        <FormControl>
                          <Input type="email" dir={isRtl ? "ltr" : undefined} className={cn(isRtl && "text-left")} placeholder="name@company.com" autoComplete="email" spellCheck={false} {...field} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
          ...
          <div className={cn("flex flex-col gap-3.5 border-t border-border/70 pt-6 sm:flex-row sm:items-center sm:justify-between", isRtl && "sm:flex-row-reverse")}>
            ...
            {isInvestor && step === 0 ? (
              <button
                ...
                className="conversion-primary-button w-full sm:w-auto"
              >
                {uiCopy.continue}
              ...
              <button
                type="submit"
                disabled={isPending}
                className="conversion-primary-button w-full disabled:cursor-not-allowed disabled:opacity-70 sm:w-auto"
              >
