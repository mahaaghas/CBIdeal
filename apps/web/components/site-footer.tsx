      ...
      <div className="container-shell py-12 md:py-14">
        ...
        >
          <div className="space-y-4">
            <BrandMark muted />
            <p className="max-w-sm text-sm leading-7 text-primary-foreground/74">
            ...
            <div className="space-y-3">
              ...
              <div className={cn("flex flex-wrap gap-3 text-sm text-primary-foreground/74", isRtl && "flex-row-reverse justify-end")}>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3 text-sm text-primary-foreground/74">
          ...
          <div className="space-y-5">
            ...
            <ul className="space-y-3.5 text-sm text-primary-foreground/74">
        ...
        <div className="border-b border-white/10 py-5">
          <p className="max-w-5xl text-sm leading-7 text-primary-foreground/70">
            CBI Deal operates with attention to EU rules, AML and KYC standards, and international sanctions requirements. Services are not made available where restrictions or compliance concerns apply.
          </p>
        </div>
        <div
          className={cn(
