          ...
          >
            ...
            >
              ...
              <div className={cn("space-y-4 md:space-y-6", compact && "space-y-[0.875rem] md:space-y-[1.125rem]")}>
                <h1
                  className={cn(
                    ...
                    hasAside
                      ? "max-w-[18ch] text-[clamp(2.35rem,3.15vw,3.3rem)] leading-[1.08] tracking-[-0.03em]"
                ...
                <p
                  className={cn(
                    ...
                    hasAside
                      ? "max-w-[40rem] text-[0.98rem] leading-[1.85] md:text-[1.02rem] md:leading-8"
              ...
              {renderStatsInPrimaryColumn ? (
                <div
                  className={cn(
                    "page-hero-stats mt-1 border-t border-white/10 pt-6",
            ...
            {hasAside ? (
              <div
                className={cn(
                  "page-hero-aside w-full max-w-[21.75rem] self-start",
